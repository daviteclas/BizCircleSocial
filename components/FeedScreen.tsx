...
import { Handshake, MessageCircle, Share2, Award } from 'lucide-react-native';
import { mockBusinessDeals } from './data/mockData';
...
const styles = StyleSheet.create({
  ...
  avatarRight: { width: 60, height: 60, borderRadius: 30, borderWidth: 2, borderColor: 'rgba(234, 179, 8, 0.2)', marginLeft: -20, zIndex: 0 },
  handshakeIcon: {
    width: 36,
    height: 36,
    borderRadius: 18,
