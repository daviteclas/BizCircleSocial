...
export const mockUsers: UserProfile[] = [
  {
    id: "1", name: "Carlos Silva", email: "carlos@techcorp.com", password: "123", company: "TechCorp Brasil", location: "São Paulo, SP", sector: "Tecnologia", avatar: 'https://i.pravatar.cc/150?u=1', bio: "CEO especializado em transformação digital com mais de 15 anos de experiência.", revenue: "R$ 5M - R$ 10M", age: 38, hasChildren: true, hobbies: "Ciclismo, Leitura, Vinho", experience: "15 anos", brands: "Microsoft, AWS, Oracle", role: 'admin', classe: 'infinity', experiencePoints: 1250, status: 'approved'
  },
  {
  ...
  {
    id: "4", name: "Marina Santos", email: "carlos@techcorp.com", password: "123", company: "Health Innovation", location: "Curitiba, PR", sector: "Medicina", avatar: 'https://i.pravatar.cc/150?u=4', bio: "Inovando na área da saúde com tecnologia de ponta.", revenue: "R$ 5M - R$ 10M", age: 39, hasChildren: true, hobbies: "Corrida, Yoga", experience: "12 anos", brands: "Hospitais de ponta", role: 'member', classe: 'membro', experiencePoints: 740, status: 'approved'
  },
  {
